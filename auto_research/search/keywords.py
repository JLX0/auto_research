...
def base_prompt_list(research_topic_prompt_string: str) -> List[str]:
    ...
    Args:
        research_topic_prompt_string (str): A detailed description of the research topic for which
         related keywords are needed.
...
def suggest_keywords(user_prompt: str, model: str, api_key: str) -> List[str]:
    ...
    Args:
        user_prompt (str): A detailed description of the research topic for which related
         keywords are needed.
