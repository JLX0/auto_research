...
class AutoSurvey :
    ...
    def __init__(
        ...
        self.ending_pages: str | None = None
    ...
    def extract_abstract(self) -> None :
        ...
        self.paper_instance.extracted_information["abstract"] = self.gpt_instance.ask(
            self.prompt_instance.prompt
            )
    ...
    def extract_introduction(self) -> None :
        ...
        self.paper_instance.extracted_information["introduction"] = self.gpt_instance.ask(
            self.prompt_instance.prompt
            )
    ...
    def extract_discussion(self) -> None :
        ...
        self.paper_instance.extracted_information["discussion"] = self.gpt_instance.ask(
            self.prompt_instance.prompt
            )
    ...
    def extract_conclusion(self) -> None :
        ...
        self.paper_instance.extracted_information["conclusion"] = self.gpt_instance.ask(
            self.prompt_instance.prompt
            )
